...
public class StandardReconConfig extends ReconConfig {
    final static Logger logger = LoggerFactory.getLogger("openrefine-authenticator");
    ...
    static public StandardReconConfig reconstruct(String json) throws IOException {
        ...
        return mapper.readValue(json, StandardReconConfig.class);
    }
    ...
    @JsonProperty("authenticatorHeader")
    final public String     authenticatorHeader;
    @JsonProperty("authenticatorToken")
    final public String     authenticatorToken;
    ...
    public StandardReconConfig(
            ...
            int limit,
            @JsonProperty("authenticatorHeader")
            String authenticatorHeader,
            @JsonProperty("authenticatorToken")
            String authenticatorToken) {
        this(service, identifierSpace, schemaSpace,
                type != null ? type.id : null,
                type != null ? type.name : null,
                autoMatch, columnDetails, limit, authenticatorHeader, authenticatorToken);
    }
    ...
    public StandardReconConfig(
        ...
        this.limit = limit;
        this.authenticatorHeader = authenticatorHeader;
    ...
    private String postQueries(String url, String queriesString) throws IOException {
        try {
            return getHttpClient().postNameValue(url, "queries", queriesString, this.authenticatorHeader, this.authenticatorToken);
    ...
    public String getMode() {
        return "openrefine-authenticator/standard-service-authenticator";
    }
}
