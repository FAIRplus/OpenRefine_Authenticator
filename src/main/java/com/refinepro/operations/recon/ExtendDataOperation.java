/*
    Custom code from original OpenRefine project main/src/com/google/refine/operations/recon/ExtendDataOperation.java
 */

package com.refinepro.operations.recon;
...
public class ExtendDataOperation extends EngineDependentOperation {
    ...
    public Process createProcess(Project project, Properties options) throws Exception {
        return new ExtendDataProcess(
                project,
                getEngineConfig(),
                getBriefDescription(null), this.authenticatorHeader, this.authenticatorToken
        );
    }
    ...
    public class ExtendDataProcess extends LongRunningProcess implements Runnable {
        ...
        public ExtendDataProcess(
            ...
            _job.authenticatorHeader = authenticatorHeader;
            _job.authenticatorToken = authenticatorToken;
        }
