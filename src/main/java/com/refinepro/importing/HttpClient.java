...
//        }
    ...
    public String postNameValue(String serviceUrl, String name, String value, String authHeader, String authToken) throws IOException {
        HttpPost request = new HttpPost(serviceUrl);
        request.addHeader(authHeader, authToken);
