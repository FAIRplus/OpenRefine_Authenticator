/*
    Custom code from original OpenRefine project main/webapp/modules/core/scripts/reconciliation/standard-service-panel.js
*/
...
ReconStandardServicePanel.prototype._guessTypes = function (f) {
    ...
    Refine.postCSRF(
        "command/openrefine-authenticator/guess-types-of-column?" + $.param({
...
ReconStandardServicePanel.prototype.start = function () {
    ...
    Refine.postProcess("openrefine-authenticator",
        "reconcile",
        {},
        {
            columnName: this._column.name,
            config: JSON.stringify({
                mode: "openrefine-authenticator/standard-service-authenticator",
                service: this._service.url,
                ...
                authenticatorHeader: this.authenticatorHeader,
